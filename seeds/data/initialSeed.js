...
const initialSeed = async () => {
  try {
    ...
    const [customersData, productsData, regionsData, ordersData] = await Promise.all([
      loadCSVData('customers', path.join(__dirname, './customers.csv')),
      loadCSVData('products', path.join(__dirname, './products.csv')),
      loadCSVData('regions', path.join(__dirname, './regions.csv')),
      loadCSVData('orders', path.join(__dirname, './orders.csv')),
    ]);
